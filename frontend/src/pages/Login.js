    ...
    <div className="surface-ground px-4 py-8 md:px-6 lg:px-8 flex align-items-center justify-content-center">
        ...
        <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6">
            <div className="text-center mb-5">
                <img src="https://lote44.com.br/wp-content/uploads/2022/04/lote44_logo2.png" alt="44Logo" height="160" className="mb-3"/>
            </div>
            ...
            <div>
                ...
                <div className="flex align-items-center justify-content-between mb-6">
                    ...
                    <button className="p-link font-medium no-underline ml-2 text-blue-500 text-right cursor-pointer">Esqueci a senha</button>
                </div>
